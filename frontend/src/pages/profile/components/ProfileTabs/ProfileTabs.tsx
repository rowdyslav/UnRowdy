import {
  profileTabsData
} from "@/pages/profile/components/ProfileTabs/profileTabsData.ts";
import type {
  profileTabsProps
} from "@/pages/profile/components/ProfileTabs/profileTabsType.ts";
    ...
    <div className='container mb-8'>
      <div className="relative flex bg-gray-100 rounded-lg p-1 w-fit">
        ...
        {profileTabsData.map((tab) => (
          <button
            key={tab.id}
            onClick={() => setActiveTab({id: tab.id, isActive: tab.label})}
